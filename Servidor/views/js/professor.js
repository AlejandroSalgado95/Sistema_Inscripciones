...
function addableTable(){
	...
	//$("#professorTable").append('<tr><td></td><td></td><td></td><td></td><td></td></tr>');
...
function addTableRow(){
		...
		var newName = $("#newRowFieldset :text")[1].value;
		var newLastName = $("#newRowFieldset :text")[2].value;
		var newPhone = $("#newRowFieldset :text")[3].value;
		var newEmail = $("#newRowFieldset :text")[4].value;
		...
		$.ajax({
			...
			success: function(dataReceived){
					...
					if (dataReceived == 0)
						alert("No fue posible agregar al profesor con la nómina: " + newId + ", esto debido a que ya existe un profesor con dicha nómina. Para dar de alta al nuevo profesor utilice una nomina diferente, o bien, elimine al profesor que actualmente está ocupando dicha nomina." );
					else if (dataReceived == 1){

						$("#professorTable").append('<tr><td>' + newId  + '</td><td>' + newName + '</td><td>' + newLastName + '</td><td>' + newPhone + '</td><td>' + newEmail + '</td></tr>');
						saveTable();
						cleanFieldset();
